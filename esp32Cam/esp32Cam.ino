...
const char* songNames[NUM_SONGS] = {"table", "sharp", "person", "obstacle", "motorbike","door","chair"};


const char* WIFI_SSID = "DHBK 412 N4 2.4G";
const char* WIFI_PASS = "hoilamgi";
 
// const char* WIFI_SSID = "TTHocLieuT2";
// const char* WIFI_PASS = "hoclieut2";
...
void setup(){
  ...
  myDFPlayer.volume(20);  // Đặt mức âm lượng (0~30).
}
